...
import { buildCartItem, buildProduct } from '../../../test-utils/fixtures'
...
const carts = [
  buildCartItem({ id: 1, iduser: '2', idproduct: 1 }),
  buildCartItem({ id: 2, iduser: '2', idproduct: 2 }),
  buildCartItem({ id: 3, iduser: '9', idproduct: 3 }),
]

const products = [
  buildProduct({ id: 1, name: 'Áo thun nữ basic' }),
  buildProduct({ id: 2, name: 'Áo sơ mi nam công sở' }),
]
