...
const Cart = () => {
  ...
  const { data: dataCart, setData: setDataCart } = useFetch<CartItem[]>(getCarts, [], [])
  ...
  const totalPrice = cartItem.reduce(
    (price, item) => price + item.amount * getDiscountedPrice(item.price, item.discount),
    0,
  )
          ...
          <div className="row container">
                  ...
                  return (
                    <div className="cart-list product" key={item.id}>
                      <div className="row cart-item">
                        ...
                        <span className="l-2 t-a-ct primary-text cart-item-total">
            ...
            <div className="c-12 m-12 l-4">
              <div className="cart-total">
                ...
                <button className="btn" onClick={goToCheckout} disabled={cartItem.length === 0}>
                  Thanh toán
                </button>
              </div>
            </div>
