...
import type { Column, Product, Order, User } from '../../interface'

export const buildProductColumns = (): Column<Product>[] => [
...
export const buildOrderColumns = (): Column<Order>[] => [
  { key: 'id', header: 'ID', className: 'id' },
  {
    key: 'name',
    header: 'Sản phẩm',
...
export const buildUserColumns = ({ onDelete }: BuildUserColumnsArgs): Column<User>[] => [
  { key: 'id', header: 'ID', className: 'id' },
